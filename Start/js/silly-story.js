...
// var noun = randomValueFromArray(verbs);

// textToSpeak = noun + verb + ...
...
function result() {
	...
	var replacex = /:insertX:/gi;
	newStory = newStory.replace(replacex, xItem);
	...
	// }
	// my value function is not working. As in my Lab1 "guess.value" didn't work same as here customName.value is not working. And i try to fix it but it don't. 
